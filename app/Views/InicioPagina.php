  ...
  <style>
    ...
    #hero {
      ...
      url('<?php echo base_url('public/images/assets/fondoPagina.jpg');?>') center/cover no-repeat fixed;
        ...
        /*animacion gradeante para el titulo de descargarla app */
...
<body id="Top" class="bg-cover bg-center bg-fixed" 
  style="background-image: url('<?php echo base_url('public/images/assets/fondoPagina.jpg');?>'); background-blend-mode: overlay; background-color: rgba(0, 0, 0, 0.5);">
    ...
    <div class="container mx-auto px-4 py-1">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center">
          <!-- Logo con tamaño vw (viewport-width) -->
           <a href="#top" class="block transition-transform duration-300 hover:scale-105"> <img src="<?php echo base_url('public/images/assets/Logo-RoarMot-Blanco.png');?>" alt="Logo RoarMot" 
                class="h-auto aspect-square
                max-w-[70px] sm:max-w-[50px] md:max-w-[50px] lg:max-w-[50px] xl:max-w-[70px] 
                w-auto object-contain">
          </a>
          <!-- Texto con ancho flexible -->
          <a href="#top" class="block transition-transform duration-300 hover:scale-105"> <img src="<?php echo base_url('public/images//assets/tipografia-roardmot-blanco.png');?>"
              alt="Tipografía RoarMot" class="w-auto h-[30px] md:h-[35px] lg:h-[40px] 
              ml-1 md:ml-2
        ...
        <!-- Sección usuario - Cambia el nombre por el de tu usuario -->
        <div class="flex items-center space-x-6">
        
          <!-- Botones de acción Y de registro menu-->
          <div class="flex space-x-4">
            <a href="<?php echo base_url('iniciarSesion');?>" 
                class="text-sm hover:text-red-400 transition-all duration-300 font-medium
                      flex items-center justify-center h-full px-3 py-2
              ...
              <!-- Efecto de fondo animado para el boton inicio de sesion -->
  ...
  <main class="relative z-10">
      ...
      <section id="hero" class="min-h-screen flex items-start justify-end relative">
        <div class="container mx-auto pt-28 pb-8 text-white mr-4 md:mr-16 lg:mr-24">
          <div class="max-w-md text-left">

            <h1 class="font-bebas text-5xl md:text-6xl mb-8 tracking-wider">
              TU MOTO, TU CONTROL
            </h1>

            <p class="font-[Arial_Black] text-3xl md:text-4xl 
                bg-clip-text text-transparent 
                bg-gradient-to-r from-red-500 to-yellow-500 
                drop-shadow-[0_0_8px_#ff000080] mb-8">
              Accede y gestiona 
        ...
        <div class="absolute bottom-14 left-1/2 -translate-x-1/2 z-20 w-full text-center px-4 "> 
            <div class="group inline-block mb-16">
                <p class="text-3xl md:text-4xl italic font-bold relative 
...
<div class="py-5 bg-gray-50"> <div class="container mx-auto px-1">
    ...
    <div class="max-w-6xl mx-auto bg-gray-900 rounded-xl shadow-2xl"> 
      <div class="flex flex-col lg:flex-row">
        <div class="lg:w-1/2 p-8 md:p-12 space-y-6 font-inter bg-[#252625]">
          <h2 class="text-4xl md:text-5xl font-bold text-white font-bebas tracking-wide leading-tight">
          ...
          </div> <div class="flex flex-wrap gap-4 pt-8">
...
<section id="Tienda" class="py-20 bg-gray-50">
  <div class="container mx-auto px-4">
    <div class="max-w-6xl mx-auto xl:max-w-7xl">
      ...
      <div class="mb-16 flex flex-col md:flex-row md:justify-between md:items-end">
        
        <div class="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
          <h2 class="text-4xl md:text-5xl font-bold text-gray-900 font-bebas tracking-wide [text-shadow:_1px_1px_2px_rgba(0,0,0,0.1)] leading-tight">
            TIENDA 
        ...
        <div class="md:w-1/2 text-center md:text-right">
            <p class="text-gray-700 text-xl md:text-3xl font-semibold max-w-xl mx-auto md:mx-0">
  ...
  <div class="container mx-auto px-4">
    ...
    <div class="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
      ...
      <div class="bg-[#151921] p-8 text-center">
        <div class="inline-flex items-center justify-center bg-orange-500 rounded-full w-16 h-16 mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
          </svg>
        </div>
        <h2 class="text-3xl md:text-4xl font-bold text-white font-bebas tracking-wide">
        ...
        <div class="p-8 md:p-10">
          ...
          <ul class="space-y-5">
            <li class="flex items-start gap-4">
              ...
              <div>
                <h4 class="font-bold text-gray-900">Proceso 100% digital</h4>
            ...
            <li class="flex items-start gap-4">
              ...
              <div>
                <h4 class="font-bold text-gray-900">Seguimiento en tiempo real</h4>
        ...
        <div class="p-8 md:p-10 bg-gray-50">
          ...
          <div class="space-y-6">
            ...
            <div class="flex gap-4">
              ...
              <div>
                <h4 class="font-bold text-gray-900">Completa tus datos</h4>
            ...
            <div class="flex gap-4">
              ...
              <div>
                <h4 class="font-bold text-gray-900">Sube los documentos</h4>
            ...
            <div class="flex gap-4">
              ...
              <div>
                <h4 class="font-bold text-gray-900">Pago seguro y envío</h4>
                <p class="text-gray-600 text-sm mt-1">Recibe tus documentos en 72 horas</p>
              </div>
            </div>
            
            <!-- Botón CTA -->
            <button class="mt-8 w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-4 px-6 rounded-lg transition-all duration-300 transform hover:scale-[1.02] shadow-md hover:shadow-lg flex items-center justify-center gap-2">
  ...
  <div class="container mx-auto px-4">
    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="text-center mb-16">
        <div class="inline-flex items-center justify-center bg-red-100 rounded-full w-20 h-20 mb-6 animate-pulse">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
          </svg>
        </div>
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 font-bebas tracking-wide">
        ...
        <div class="flex flex-col lg:flex-row">
          ...
          <div class="lg:w-2/5 bg-gray-900 flex justify-center items-center p-8">
            <div class="relative w-56">
              <img src="assets/mockup-alertas.png" alt="Alertas en la app" class="w-full h-auto">
              <div class="absolute inset-0 flex items-center justify-center p-4">
                <img src="assets/alertas-screen.png" alt="Pantalla de alertas" class="rounded-md w-full h-auto border border-gray-700">
              </div>
            </div>
          </div>
          
          <!-- Texto CTA -->
          <div class="lg:w-3/5 p-10 flex flex-col justify-center">
            <h3 class="text-2xl font-bold text-gray-900 mb-4">¿Listo para mantener tu moto al día?</h3>
            <p class="text-gray-600 mb-6">Activa las notificaciones y recibe recordatorios precisos directamente en tu celular</p>
            <div class="flex flex-col sm:flex-row gap-4">
              <a href="#" class="flex-1 bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-6 rounded-lg text-center transition-colors flex items-center justify-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                </svg>
                Activar alertas
              </a>
              <a href="#" class="flex-1 border-2 border-gray-900 hover:bg-gray-900 hover:text-white text-gray-900 font-bold py-4 px-6 rounded-lg text-center transition-colors">
                Ver tutorial
              </a>
            </div>
          </div>
  ...
  <div class="max-w-4xl mx-auto text-center">
    ...
    <div class="grid gap-6 md:grid-cols-3">
      ...
      <div class="bg-white p-6 rounded-lg shadow-md border border-red-100">
        ...
        <a href="#guia-desvararse" class="text-red-500 hover:underline mt-2 inline-block">Ver guía</a>
      </div>
      ...
      <div class="bg-white p-6 rounded-lg shadow-md border border-red-100">
        ...
        <a href="tel:+34123456789" class="text-red-500 hover:underline mt-2 inline-block">📞 Llamar ahora</a>
      </div>
...
<!-- FOOTER -->
  <footer class="bg-black text-gray-300 px-6 py-8 text-center">
